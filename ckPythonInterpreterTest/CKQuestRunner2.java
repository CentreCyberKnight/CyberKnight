...
{ 
	...
	Quest quest;
	 ...
	 public CKQuestRunner2(QuestData q) 
	 {
		 quest = new Quest(q);
		 ...
		 //MKB called from other boss frame... 
		 ...
		 frame.addWindowListener(new WindowAdapter()
		 {
			...
			{
				CKGameObjectsFacade.setQuest(null);
		 ...
		 String cmd = "from ckPythonInterpreter.CKEditorPCController import * \n"+
				 "move('Forward',1)\n";				 
	 ...
	 private JPanel createEditorPane()
	 {
	    ...
	    return pane;
	 	...
	 	private class ButtonHandler implements ActionListener
	 	{
	 		public void actionPerformed(ActionEvent event)
	 		{
	 			...
	 			//limits the CP used with in the turn
	 	...
	 	private class consoleThreadFinishes implements CKThreadCompletedListener
	 	{
			...
			{
				CKGameObjectsFacade.disableTextInput();
				//TODO why is this necessary here but not in WorkshopTest?
		...
		public static void main(String[] args) {
	        ...
	        @Override
	        	public void run() 
	        	{
	        	CKQuestFactory qf = CKQuestFactory.getInstance();
	            	new CKQuestRunner2(qf.getAsset("quest3"));//.setVisible(true);
