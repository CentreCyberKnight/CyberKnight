...
public class BlenderCKURL
{
	private URL url = null;
	private static boolean setAuth=false;
	
	public BlenderCKURL(String filename) throws MalformedURLException
	{	//setAuth=true; //TODO get rid of this eventually
		if( ! setAuth )
		{
			Authenticator.setDefault(new BlenderMyAuth());
			setAuth=true;
		}
	...
	public static void copyURL(BlenderCKURL from, BlenderCKURL to)
	{
		try
		{
	...
	public static void main(String [] args)
	{
		try
		{
			...
			BlenderCKURL url = new BlenderCKURL("images/babysheet.png");
			//System.out.println(url);
			...
			BlenderCKURL local = new BlenderCKURL(CKConnection.getCKSettingsDirectory()+File.separator+"bradshaw.jpg");
			System.out.println("local:"+local);
			
			CKProperties.setValue("RESOURCEPATH","ftp://cyberknight:resources@grim.hanover.edu/images/");
			BlenderCKURL network = new BlenderCKURL("bradshaw2.jpg");
...
class BlenderMyAuth extends Authenticator
{
